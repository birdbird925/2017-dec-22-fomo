...
// switch currency
Route::get('/currency/{currency}/update', 'CurrencyController@update');
// login
...
Route::get('/cart/{id}/quantity/{quantity}/update', 'CartController@updateQuantity');
// checkout
...
Route::post('/checkout/paypal/payment/create', 'CheckoutController@createPayment');
Route::post('/checkout/paypal/payment/execute', 'CheckoutController@executePayment');
